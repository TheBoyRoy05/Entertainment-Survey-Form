...
CREATE TABLE public.astronomer (
    ...
    galaxy_discovery integer,
    star_discovery integer,
    planet_discovery integer,
    moon_discovery integer
);
...
CREATE TABLE public.moon (
    ...
    name character varying(255) NOT NULL,
    min_distance_to_host integer,
    max_distance_to_host integer,
    description text,
    planet_id integer
);
...
--
-- Name: astronomer astronomer_galaxy_discovery_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.astronomer
    ADD CONSTRAINT astronomer_galaxy_discovery_fkey FOREIGN KEY (galaxy_discovery) REFERENCES public.galaxy(galaxy_id);


--
-- Name: astronomer astronomer_moon_discovery_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.astronomer
    ADD CONSTRAINT astronomer_moon_discovery_fkey FOREIGN KEY (moon_discovery) REFERENCES public.moon(moon_id);


--
-- Name: astronomer astronomer_planet_discovery_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.astronomer
    ADD CONSTRAINT astronomer_planet_discovery_fkey FOREIGN KEY (planet_discovery) REFERENCES public.planet(planet_id);


--
-- Name: astronomer astronomer_star_discovery_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.astronomer
    ADD CONSTRAINT astronomer_star_discovery_fkey FOREIGN KEY (star_discovery) REFERENCES public.star(star_id);
